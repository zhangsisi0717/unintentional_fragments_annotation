...
len(final_matching_results[
        0].sum_matched_results_mona)  # if total_layer_matchin=1, n_candidates_further_matched=3, then there are 3^2 paths
final_matching_results[0].sum_matched_results_mona[0]  # A dictionary for first path matching result of basis group 0
final_matching_results[0].sum_matched_results_mona[0][
    'candi_list_each_matching_layer']  # matching results (candidates and scores) for all matching layer)
