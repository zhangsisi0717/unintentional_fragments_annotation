...
- Process the .json files using 'MoNA_data_filter.py' file to only extract the needed spectra information and save as 'mona_neg_cleaned.pkl' or 'mona_pos_cleaned.pkl'.
